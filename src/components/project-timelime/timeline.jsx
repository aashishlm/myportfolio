...
// projects
import Currency from "../../assets/img/projects/currency.jpg";
        ...
        <ImageEvent
          ...
          >
            <div className="d-flex justify-content-between flex-column mt-1">
              <div>
                <Accordion>
                  <Card>
                    ...
                    <Accordion.Collapse eventKey="0" className="text-left">
                      <Card.Body>
                        <strong>Description:</strong> This is a Currency Search app where you can search the diffecrent Crypto Currency
                        <hr />
                        <strong>Features:</strong>
                        <ul className="list-styles pt-1">
                          <li>Gives you rate of Cryptocurrency</li>
              ...
              <div className="d-flex justify-content-between flex-nowrap text-center">
                <UrlButton
                  href="https://aashishlm.github.io/cryptosearch/"
                  target="_blank"
                >
                  SEE LIVE
                </UrlButton>
                <UrlButton
                  href="https://github.com/aashishlm/cryptosearch"
                  target="_blank"
                >
                  SOURCE CODE
                </UrlButton>
